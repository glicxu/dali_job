...
- [ ] **MOB-04:** Implement resume upload, parse status, failure recovery, and confirmation. PDF/TXT upload, user-exported LinkedIn profile PDF import, parsed-profile application, and manual profile fallback are implemented; parse preview/edit confirmation and explicit retry remain.
