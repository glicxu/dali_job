...
- [ ] **MOB-04:** Implement resume upload, parse status, failure recovery, and confirmation.
- [ ] **MOB-05:** Implement criteria and automation settings.
- [ ] **MOB-06:** Display tier allowance, current-period usage, and the next scheduled run. Backend entitlement, usage-ledger, schedule, and run-detail contracts are implemented; native display work remains.
- [ ] **MOB-07:** Implement match inbox, match details, external job link handling, and read state.
