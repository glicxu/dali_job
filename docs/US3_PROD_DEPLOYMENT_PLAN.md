...
- 2026-08-15: Deployed the mobile guest-trial and internal-super backend working tree as artifact SHA-256 `ac18e50474821d4b7efa6bd79b8fc9e4775eddb65741f23bc5c90e2d53b45d79`; retained the predeployment source, nanny, and crontab under `/home/dali-op/dali/releases/dali_job/20260815_121726`; migrated production from `0036` through `0038`; restarted the API; enabled nanny-managed automation/digest workers plus one-minute dispatch and 15-minute guest purge schedules; assigned `job@dalifin.local` to `super`; and verified a live Run Now completed with 10 discovered jobs and one persisted match.
