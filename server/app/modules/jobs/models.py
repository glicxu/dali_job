...
class JobMatchFeedback(Base):
    ...
    __table_args__ = (
        CheckConstraint("score >= 0 AND score <= 100", name="ck_job_match_feedback_score"),
        UniqueConstraint("user_id", "job_resume_match_id", name="uq_job_match_feedback_user_match"),
    )
