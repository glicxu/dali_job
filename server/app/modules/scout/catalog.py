...
ACTION_CATALOG: dict[str, ScoutActionDefinition] = {
    ...
    for item in (
        ...
        ScoutActionDefinition("open_match", "Open Match", "/match", "Compare a resume profile with pasted job details or one or more saved jobs.", ("job_ids", "resume_profile_id")),
        ...
        ScoutActionDefinition("open_manual_job", "Create Job Entry", "/jobs/manual", "Create a job entry from a title and pasted description."),
